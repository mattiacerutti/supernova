...
export default function AssistantCompaction(props: AssistantCompactionProps) {
  ...
  return (
    <section className="space-y-2">
      <Button className="group inline-flex w-fit select-none items-center gap-1.5 px-0 py-0 text-sm text-ink-muted hover:text-ink-muted" onClick={handleToggle} variant="ghost">
