...
import {USER_MESSAGE_CONTENT_PARTS_CUSTOM_TYPE, imageContentFromParts} from "@supernova/agent-runtime/layers/shared/lib/user-message/content-parts";
import {buildPrompt} from "@supernova/agent-runtime/layers/session-runtime/lib/user-message/prompt-builder";
